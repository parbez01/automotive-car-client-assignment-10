...
const Navbar = () => {
  ...
  const Navlinks = <>
    ...
    <li className="text-xl"><NavLink to='/addProduct'>Add Product</NavLink></li>
    <li className="text-xl"><NavLink to='/myCart'>My Cart</NavLink></li>
...
<img className="w-16 h-16 rounded-full shadow-xl" src="https://i.ibb.co/XXf1Y50/7873740.jpg" alt="" />
...
<label className="swap swap-rotate">
          ...
          {/* sun icon */}
          <svg
            className="swap-on fill-current  lg:mt-0 -mt-4  w-10 h-10"
          ...
          {/* moon icon */}
          <svg
            className="swap-off fill-current lg:mt-0 -mt-4 w-10 h-10"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          >
